...
<body>
    <h1>🔧 BurudaniKiganjani API Diagnostic Tool</h1>
...
test('Comments List Endpoint', function() {
    $url = 'http://localhost/BurudaniKiganjani/api/comments/list.php?content_id=20';
...
test('Ratings Rate Endpoint (POST)', function() {
    $url = 'http://localhost/BurudaniKiganjani/api/ratings/rate.php';
