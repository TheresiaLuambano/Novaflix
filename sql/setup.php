 ...
 * Run: http://localhost/BurudaniKiganjani/sql/setup.php
 */
...
echo "<!DOCTYPE html><html><head><title>Database Setup - BurudaniKiganjani</title>";
echo "<style>
...
echo "<h1>🗄️ BurudaniKiganjani Database Setup</h1>";
...
try {
    ...
    echo "<p>Make sure MySQL is running and the database 'burudani' exists.</p>";
    echo "</div>";
}
