 ...
 * Run this file directly in your browser: http://localhost/BurudaniKiganjani/sql/seed.php
 */
...
echo "<!DOCTYPE html><html><head><title>Database Seeder - BurudaniKiganjani</title>";
echo "<style>
...
echo "<h1>🎬 BurudaniKiganjani Database Seeder</h1>";
